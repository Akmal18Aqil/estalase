...
export async function sendInviteEmail(email: string, storeName: string) {
    try {
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <br/>
          <a href="http://localhost:3000/" style="background-color: #000; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
            Daftar Sekarang
          </a>
          <p style="margin-top: 20px; font-size: 12px; color: #666;">
            Jika tombol di atas tidak berfungsi, copy link ini: http://localhost:3000/
          </p>
        </div>
      `,
        })
